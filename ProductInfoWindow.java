...
public class ProductInfoWindow {
	...
	//Window which display the info of a product
	public ProductInfoWindow(Product aProduct) {
		theProduct = aProduct;
		this.display();
	    }
	//THe display/GUI cide
	public void display() {
		  Font defaultFont = new Font("Candara", Font.BOLD, 20);
	        ...
	        /*
	        numBugs.setBorder(new EmptyBorder (9, 0, 9, 0));
	        numBugs.setForeground(new Color(0, 0, 0));
			numBugs.setFont(new Font("Britannic Bold", Font.BOLD, 26));
	        userPanel.add(numBugs);
	        */
